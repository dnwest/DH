...
function renderizarDadosUsuario(dados) {
    ...
    let img = dados.resultado[0].imagem.grande
    let nome = dados.resultado[0].nome.primeiro
    let sobrenome = dados.resultado[0].nome.utlimo
    let email = dados.resultado[0].email
